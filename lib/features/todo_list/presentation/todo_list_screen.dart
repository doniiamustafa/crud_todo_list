...
import 'package:crud_local_testing_app/features/notifications/notification_services.dart';
...
class _TodoListScreenState extends State<TodoListScreen> {
  ...
  Widget build(BuildContext context) {
    notificationServices.sendNotification("Hello!", "Todo List Reminder :)");
                            ...
                            child: Dismissible(
                              ...
                              onDismissed: (DismissDirection direction) {
                                setState(() {
                                  ...
                                  screenData =
                                      databaseHandler!.getTodoListData();
